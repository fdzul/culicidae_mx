...
![](){.absolute top=425 left=1100 width="300"}
![](){.absolute top=680 left=1250 width="300"}
...
::: {.column width="40%"}
```{r}
fs::dir_tree("/Users/fdzul/Dropbox/projects/culicidae_mx", 
             recurse = 0)
```
...
```{r}
fs::dir_tree("/Users/fdzul/Dropbox/projects/culicidae_mx/1.datasets", 
             recurse = 0)
```
...
```{r}
fs::dir_tree("/Users/fdzul/Dropbox/projects/culicidae_mx/1.datasets/1.1.raw_data", 
             recurse = 1)
```
